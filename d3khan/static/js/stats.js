const Stats = {
  ...
  renderTable() {
    ...
    if (this.contracts.length === 0) {
      tbody.innerHTML = '<tr><td colspan="7" style="text-align:center;padding:32px 0;font-style:italic;">No active contracts. Start the engine to begin trading.</td></tr>';
      return;
    }
